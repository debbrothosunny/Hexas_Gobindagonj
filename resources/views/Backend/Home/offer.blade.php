...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Tables /</span> Offer Title Tables</h4>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse ($offer_title as $postData)
                            <tr>
        ...
        <h4 class="fw-bold py-3 mb-2 mt-5"><span class="text-muted fw-light">Tables /</span> Offer Content Tables</h4>
        <!-- Basic Bootstrap Table -->
        <div class="card">
            <div class="mt-4 mb-3">
                <nav class="navbar navbar-example navbar-expand-lg">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse ($offer_content as $postData)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $postData->title }}</td>
                                <td>{!! Str::limit($postData->description, '30', '...') !!}</td>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="{{'#offer_content_dlt'.$postData->id.'offer_content_delete'}}"><i class="bx bx-trash me-1"></i></button>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <div class="modal fade" data-bs-backdrop="static" id="largeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('offer.title.create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade" data-bs-backdrop="static" id="{{'Edit'.$postData->id.'update'}}" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('offer.title.update',$postData->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-0">
        ...
        <div class="modal fade" data-bs-backdrop="static" id="{{'dlt'.$postData->id.'delete'}}" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('offer.title.delete',$postData->id) }}" method="get" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
    ...
    {{-- **************Offer Title Modal Start************* --}}
        ...
        <div class="modal fade" data-bs-backdrop="static" id="offer_content" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('offer.content.create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="row g-2">
                                <div class="col mb-0">
        ...
        @foreach ($offer_content as $postData)
            <div class="modal fade" data-bs-backdrop="static" id="{{'offer_content_Edit'.$postData->id.'offer_content_update'}}" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form action="{{ route('offer.content.update',$postData->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                <div class="row g-2">
                                    <div class="col mb-0">
        ...
        <!-- Delete Modal -->
        @foreach ($offer_content as $postData)
            <div class="modal fade" data-bs-backdrop="static" id="{{'offer_content_dlt'.$postData->id.'offer_content_delete'}}" tabindex="-1"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form action="{{ route('offer.content.delete',$postData->id) }}" method="get" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                <h5 class="text-center">Are You Sure?</h5>
                            </div>
