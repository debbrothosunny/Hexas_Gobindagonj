                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse ($site as $postData)
                            <tr>
                                ...
                                <td>{!! Str::limit($postData->phone, '30', '...') !!}</td>
                                <td>{!! Str::limit($postData->email, '30', '...') !!}</td>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-0">
                                ...
                                <input required type="file" id="emailLarge" class="form-control" name="logo"/>
                        ...
                        <div class="row">
                            <div class="col-6 mb-0">
                                ...
                                <input required type="text" id="dobLarge" class="form-control" name="email"
                                    placeholder="Email" />
                                <span class="text-danger">
                                    @error('email')
                                        {{ $message }}
                            ...
                            <div class="col-6 mb-0">
                                <label for="dobLarge" class="form-label">Phone</label>
                                <input required type="text" id="dobLarge" class="form-control" name="phone"
