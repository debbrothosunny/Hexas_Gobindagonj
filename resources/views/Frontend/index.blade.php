    ...
    @foreach ($about as $postData)
        <div class="about-home" id="about">
            <div class="container">
                ...
                <div class="about-right">
                    ...
                    <a href="#demo-modal" class="about-video">
        ...
        <div id="demo-modal" class="modal">
            <div class="modal__content">
                <iframe width="560" height="315" src="{!! $postData->video !!}" title="YouTube video player"
                    frameborder="0"
                ...
                <div>
                    <div class="course-box">
                        ...
                        <div class="course-text">
                            ...
                            <p>
                            {!! Str::limit(strip_tags($postData->description), '120', '...') !!}
                            </p>
