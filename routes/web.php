...
Route::get('certificate/verify', [FrontendController::class, 'certificate'])->name('certificate.verify');

Route::get('/blog',[FrontendController::class,'blog']);

Route::get('/blog/single/{id}',[FrontendController::class,'blog_Single'])->name('blog.Single');
Route::post('/blog/comment', [FrontendController::class, 'comment_create'])->name('comment');
...
Route::post('/admission', [FrontendController::class, 'admission_create'])->name('create.admission');
...
Route::prefix('site')->middleware(['auth'])->group(function () {
    ...
    Route::get('SM/',[FrontendController::class,'Message'])->name('show.Message');
    Route::get('Message/delete/{id}',[FrontendController::class,'Message_delete'])->name('Message.delete');

    Route::get('add/',[FrontendController::class,'admission'])->name('show.admission');
    Route::get('add/delete/{id}',[FrontendController::class,'admission_delete'])->name('admission.delete');
});
...
Route::prefix('blog')->middleware(['auth'])->group(function () {
    ...
    Route::get('pCp/p',[FrontendController::class,'comment'])->name('comment.back');
    Route::get('comment/delete/{id}',[FrontendController::class,'Comment_delete'])->name('delete.comment_delete');
});
